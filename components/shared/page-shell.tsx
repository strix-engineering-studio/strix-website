  ...
  return (
    <section className="px-3 py-8 sm:px-4 lg:px-6 lg:py-10">
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="overflow-hidden rounded-[36px] border border-border/70 bg-[linear-gradient(135deg,rgba(216,158,88,0.16),rgba(122,168,112,0.09)_36%,rgba(255,255,255,0.04))] px-5 py-6 shadow-[0_24px_80px_rgba(0,0,0,0.22)] sm:px-6 sm:py-8 lg:px-8 lg:py-10">
