          ...
          <div className="sticky top-28 space-y-4 rounded-[28px] border border-white/10 bg-white/4 p-4 backdrop-blur-xl">
            ...
            <div className="space-y-2 border-t border-white/10 pt-4">
              {sections.map((section) => (
                <a key={section.id} href={`#${section.id}`} className="block rounded-xl px-3 py-2 text-sm text-muted-foreground transition hover:bg-white/6 hover:text-foreground">
                  {section.label}
                </a>
              ))}
            </div>
          ...
          <section id="solution" className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="rounded-[30px] border border-white/10 bg-white/4 p-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm uppercase tracking-[0.3em] text-white/45">System flow</p>
                  <p className="text-lg font-semibold text-foreground">Architecture diagram</p>
                </div>
              </div>
              <div className="mt-5 grid gap-3 sm:grid-cols-3">
  ...
  return (
    <div className="rounded-[30px] border border-white/10 bg-white/4 p-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <p className="text-sm uppercase tracking-[0.3em] text-white/45">{title}</p>
